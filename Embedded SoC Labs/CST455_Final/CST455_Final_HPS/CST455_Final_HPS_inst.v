	CST455_Final_HPS u0 (
		...
		.hex0_conduit                    (<connected-to-hex0_conduit>),                    //        hex0.conduit
		.hex1_conduit                    (<connected-to-hex1_conduit>),                    //        hex1.conduit
		.hex2_conduit                    (<connected-to-hex2_conduit>),                    //        hex2.conduit
		.hex3_conduit                    (<connected-to-hex3_conduit>),                    //        hex3.conduit
		.hex4_conduit                    (<connected-to-hex4_conduit>),                    //        hex4.conduit
		.hex5_conduit                    (<connected-to-hex5_conduit>),                    //        hex5.conduit
