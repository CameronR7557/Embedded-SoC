...
add wave -noupdate -label LOAD /testbench/T1/load
add wave -noupdate -label RX_DATA -radix binary /testbench/T1/RX_data
add wave -noupdate -divider Outputs
add wave -noupdate -label RD_DATA /testbench/T1/readdata
add wave -noupdate -divider REGS
add wave -noupdate -label RD_FLAG /testbench/T1/readFlag
